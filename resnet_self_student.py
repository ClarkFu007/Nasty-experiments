...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        # return [out4, out3, out2, out1], activation1, activation2, activation3, activation4  # zero_shot
        return [out4, out3, out2, out1], [out4_feature, out3_feature, out2_feature, out1_feature]  # self-distill
