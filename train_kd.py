...
parser.add_argument('--teacher_resume', default="/home/yaof/trained_models/res50_undis_cifar100_1", type=str,
...
if __name__ == "__main__":
    ...
    json_path = os.path.join(args.save_path, 'params_kd.json')
